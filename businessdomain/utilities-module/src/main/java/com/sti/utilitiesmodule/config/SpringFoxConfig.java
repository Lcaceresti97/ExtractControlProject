package com.sti.utilitiesmodule.config;
...
public class SpringFoxConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Module Utilities")
    ...
    public Docket petApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("moduleUtilities-apis")
                .apiInfo(apiInfo())
                //set up JWT input
                ...
                .build()
                .tags(new Tag("Module Utilities API", "All apis relating to module Utilities service") {
                      });
    }
