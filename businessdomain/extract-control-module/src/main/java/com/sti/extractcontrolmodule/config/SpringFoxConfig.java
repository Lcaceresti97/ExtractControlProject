...
public class SpringFoxConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Module Extract Log")
                .description("Extracted Log module API reference for developers, teh error handler is implement using \n"
    ...
    public Docket petApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("moduleExtractControl-apis")
                .apiInfo(apiInfo())
                //set up JWT input
                ...
                .build()
                .tags(new Tag("Module Extract Control API", "All apis relating to module Extract Control service") {
                });
    }
